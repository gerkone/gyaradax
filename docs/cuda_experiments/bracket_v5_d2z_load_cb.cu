...
//
// Three variants compiled into one fatbin:
//   d_v5_d2z_fp32_load -- reads float2, computes bracket in FP32, returns float
//   d_v5_d2z_mp_load   -- reads float2, promotes to double for bracket (legacy)
