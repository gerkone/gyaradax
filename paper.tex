...
\twocolumn[
\icmltitle{
\raisebox{-4.0pt}{\includegraphics[width=1.2em]{figures/gyarados_logo.png}}\hspace{0.2em}%
...
%
Moreover, we execute empirical numerical alignment against additional GKW reference trajectories for ITG turbulence \cite{paischer2025gyroswin}.
...
\begin{itemize}
    \item \textbf{Inverse Parameter Identification.} Recovering profile gradients via AD-driven optimization.
    \item \textbf{Sensitivity Analysis.} Pass-efficient computation of stability gradients across profiles.
    \item \textbf{HPC Performance.} Speed benchmark against GKW.
\end{itemize}
