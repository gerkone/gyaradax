...
\texttt{gyaradax} solves the collisionless electrostatic gyrokinetic equations in the local flux-tube limit, supporting both adiabatic and kinetic electron models. We designed it to be a slim, modern and ML-friendly alternative to GKW, written in JAX with the core solver in approximately 2000 lines.
...
\textbf{Models.}
Regarding the specific models used, our original attempt was with Google Gemini 3.1 Pro \cite{gemini31pro_2026} through the \texttt{gemini-cli} agent. However, for multiple times this produced unreasonable results and was blocked by the authors before reaching the later testing stages.
%
We transitioned to OpenAI GPT-5.3 CODEX \cite{openai_gpt53_codex_2026}, which ended up performing the heavy lifting of the port.
%
Gemini 3.1 Flash and Pro models were mostly applied to refactoring and paper writing. With the entire codebase into context, we found Gemini to be quite capable of producing documentation material.
%
The final performance optimizations was ...\GG{claude?}
