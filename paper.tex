...
We verify \texttt{gyaradax} by empirical numerical alignment against reference GKW trajectories for ion-temperature-gradient (ITG) turbulence, covering both adiabatic \cite{paischer2025gyroswin} and kinetic electrons.
