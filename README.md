...
df, phi, fluxes, state = gksimulate(df, geometry, params, state, 400,
                                    pre=pre, output_dir="outputs", checkpoint_interval=40,
                                    log_fn=default_log)
```
...
state_ckpt = GKState(time=ckpt["time"], step=ckpt["step"],
